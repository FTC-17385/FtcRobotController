...
public class VisionHardware2 {
    ...
    public VisionHardware2(LinearOpMode opmode) { myOpMode = opmode; };

    public VisionHardware2(LinearOpMode opmode, ALLIANCE_POS alliancePos) {
        myOpMode = opmode;
        this.alliancePos = alliancePos;
    }
    public VisionHardware2(LinearOpMode opmode, ALLIANCE_POS alliancePos, GlobalConfig globalConfig) {
        myOpMode = opmode;
        this.alliancePos = alliancePos;
    ...
    public boolean detectTag(int DESIRED_TAG_ID, MotionHardware2 robot, int DESIRED_DISTANCE) {
