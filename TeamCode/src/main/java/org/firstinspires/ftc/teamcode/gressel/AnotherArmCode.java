...
public class AnotherArmCode extends OpMode {
    ...
    public void loop() {
        // Drive control
        double drive = -gamepad1.left_stick_y;  // Pushing left stick forward moves the robot forward
        double strafe = gamepad1.left_stick_x;   // Moving left stick left/right moves the robot left/right
        double rotate = -gamepad1.right_stick_x;  // Moving right stick left/right rotates the robot
